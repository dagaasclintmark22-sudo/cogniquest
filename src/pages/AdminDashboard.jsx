  ...
  return (
    <div>
      ...
      <ConfirmationModal
        ...
        title="Seed Database"
        message="Are you sure you want to seed the database? This will add all categories and quizzes. It will not delete existing data, but may create duplicates if run multiple times."
