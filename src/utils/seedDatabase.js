...
import { bpedPart1 } from './bpedData';
import { bpedPart2 } from './bpedData2';
import { bpedPart3 } from './bpedData3';
...
const seedQuiz = async (batch, categoryName, categoryDesc, quizTitle, quizDesc, questionsData, categoryCache) => {
  try {
    ...
    if (!quizSnapshot.empty) {
      console.log(`Quiz "${quizTitle}" already exists. Updating...`);
      quizRef = doc(db, "quizzes", quizSnapshot.docs[0].id);
    } else {
      quizRef = doc(collection(db, "quizzes"));
    }
    ...
    console.log(`Quiz "${quizTitle}" staged for creation/update.`);
  } catch (error) {
...
export const seedDatabase = async () => {
  ...
  try {
    ...
    // 4. Seed BPED Quizzes
    // await seedQuiz(batch, "BPED Comprehensive Exam", "Comprehensive exams for BPED.", "BPED COMPREHENSIVE EXAM Part 1", "BPED Comprehensive Exam Part 1", bpedPart1, categoryCache);
    // await seedQuiz(batch, "BPED Comprehensive Exam", "Comprehensive exams for BPED.", "BPED COMPREHENSIVE EXAM Part 2", "BPED Comprehensive Exam Part 2", bpedPart2, categoryCache);
    // await seedQuiz(batch, "BPED Comprehensive Exam", "Comprehensive exams for BPED.", "BPED COMPREHENSIVE EXAM Part 3", "BPED Comprehensive Exam Part 3", bpedPart3, categoryCache);

    for (const config of seedConfig) {
      await seedQuiz(batch, config.categoryName, config.categoryDesc, config.quizTitle, config.quizDesc, config.data, categoryCache);
    }
...
export const seedConfig = [
  {
    categoryName: "BPED Comprehensive Exam",
    categoryDesc: "Comprehensive exams for BPED.",
    quizTitle: "BPED COMPREHENSIVE EXAM Part 1",
    quizDesc: "BPED Comprehensive Exam Part 1",
    data: bpedPart1
  },
  {
    categoryName: "BPED Comprehensive Exam",
    categoryDesc: "Comprehensive exams for BPED.",
    quizTitle: "BPED COMPREHENSIVE EXAM Part 2",
    quizDesc: "BPED Comprehensive Exam Part 2",
    data: bpedPart2
  },
  {
    categoryName: "BPED Comprehensive Exam",
    categoryDesc: "Comprehensive exams for BPED.",
    quizTitle: "BPED COMPREHENSIVE EXAM Part 3",
    quizDesc: "BPED Comprehensive Exam Part 3",
    data: bpedPart3
  }
];
