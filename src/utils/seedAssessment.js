...
export const seedAssessment = async () => {
  ...
  try {
    ...
    // 2. Prepare Questions
    const formattedQuestions = assessmentData.map(item => ({
      text: item.q,
    ...
    batch.set(quizRef, {
      ...
      description: "Comprehensive assessment covering 150 items.",
      categoryId: categoryId,
      questions: formattedQuestions
    });

    await batch.commit();
    console.log("Assessment Quiz Seeded Successfully!");
    return true;
  } catch (error) {
